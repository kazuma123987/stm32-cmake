...
set(CMAKE_C_FLAGS "-x c -std=c99 ${MCPU_FLAGS} ${VFP_FLAGS} ${COMMON_FLAGS}")
...
#设置汇编语言(ASM)编译参数
set(CMAKE_ASM_FLAGS "${MCPU_FLAGS} ${VFP_FLAGS} -x assembler")
...
set(LINKER_FLAGS "-Wl,-Map=${PROJECT_NAME}.map -Wl,--gc-sections,--print-memory-usage")
